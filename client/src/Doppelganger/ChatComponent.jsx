...
export default function ChatComponent() {
    ...
    const [messageHistory, setMessageHistory] = useState([
        ...
        {"system_message": `You are ${customizations.doppelganger}, ${customizations.user}'s Doppelganger. Their personality type is ${customizations.personality}. You provide information about their skills and experience. Answer as concisely as possible. They are skilled in ${customizations.stack}. They also have experience in ${customizations.otherSkills.join(", ")}. They have worked on the following projects: ${customizations.projects.join(", ")}. Respond in one sentence, and a question sometimes.`},
